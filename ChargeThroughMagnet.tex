...
\begin{align}
    \label{eq:2}
    B = \frac{\sqrt{2}}{r}\sqrt{\frac{m}{q}}\sqrt{U}.
\end{align} 
If units are given:
\begin{align}
...
\end{align}
\begin{align}
    B = \frac{\sqrt{2}}{r[\si{cm}]\SI{e-2}{}}\sqrt{\frac{m[\si{amu}]}{q[\si{e}]}}\sqrt{\frac{\SI{1.67e-27}{}}{\SI{1.6e-19}{}}}\sqrt{U[\si{kV}]}10^{\frac{3}{2}} 
      = \frac{0.457}{r[\si{cm}]}\sqrt{\frac{m[\si{amu}]}{q[\si{e}]}}\sqrt{U[\si{kV}]} [\si{T}].
\end{align}
